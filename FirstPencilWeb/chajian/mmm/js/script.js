$(function(){
    ...
    $('.press img').on('click',function(){
    	...
    	new_html += '<div class="invite"><img src="../../chajian/mmm/images/14-1.png" /></div>';
    	new_html += '</div>';
    	$(this).parents(".n13").css("background", "url(../../chajian/mmm/images/14.png) center center no-repeat").html(new_html);
